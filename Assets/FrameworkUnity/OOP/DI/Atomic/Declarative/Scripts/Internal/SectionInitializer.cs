...
{
    internal static class SectionInitializer
    {
        private static readonly Type INIT_ATTRIBUTE_TYPE = typeof(ConstructAttribute);
        ...
        internal static void InitSection(object section, DeclarativeModel root)
        {
            ...
            for (int i = 0, count = methods.Count; i < count; i++)
            {
                ...
                if (method.IsDefined(INIT_ATTRIBUTE_TYPE))
                {
